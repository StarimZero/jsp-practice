	...
	<div class="container-fluid" >
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item" id="admin_order-item"><a class="nav-link active" aria-current="page" href="/admin/order/list" style="color: #839bd6">주문관리</a></li>
			</ul>
			...
			<ul class="navbar-nav mb-2 mb-lg-0"> <!-- 마진엔드-오토 빼기 -->
				...
				<li class="nav-item" id="order-item"><a class="nav-link active" aria-current="page" href="/order/list" style="color: #839bd6">주문목록</a></li>
			</ul>
		</div>
	</div>
</nav>
