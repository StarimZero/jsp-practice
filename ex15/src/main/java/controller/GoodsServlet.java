...
@WebServlet(value={"/goods/list.json", "/goods/search", "/goods/search.json", "/goods/insert", "/goods/list", "/goods/delete", "/goods/total", "/goods/read", "/admin/order/list", "/admin/order/list.json", "/admin/order/update"})
public class GoodsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/goods/insert":
			...
			vo.setMallName(request.getParameter("mallName"));
