...
public class ReviewDAO {
	...
	public void update(ReviewVO vo) {
		try {
			...
			System.out.println("리뷰수정하다가 오류" + e.toString());
		}
	}
	...
	public void delete(int rid) {
		try {
			...
			System.out.println("리뷰삭제하다가 오류" + e.toString());
		}
	}
	...
	public int total (String gid) {
		...
		try {
			...
			System.out.println("전체리뷰수 구하다가 오류" + e.toString());
		}
		return total;
	}
	...
	public ArrayList<ReviewVO> list (QueryVO vo, String gid){
		...
		try {
			...
			System.out.println("리뷰 목록 불러오다가 오류" + e.toString());
		}
		return array;
	}
	...
	public void insert(ReviewVO vo) {
		try {
			...
			System.out.println("리뷰등록하다가 오류" + e.toString());
		}
