	...
	<div class="col-10 col-md-8 col-lg-5">
		<div class="card">
			<div class="card-header">
				<h3 class="text-center my-3">강좌 수정</h3>
			</div>
			<div class="card-body">
				<form name="frm">
					...
					<div class="input-group mb-2">
						...
						<input name ="persons" class="form-control" type="number"  value="${cou.persons}">
					</div>
					<div class="input-group mb-2">
					...
					<div class="text-end mt-3">
						...
						<button class="btn btn-primary">강좌 수정</button>
					</div>
				</form>
			</div>
		</div>
