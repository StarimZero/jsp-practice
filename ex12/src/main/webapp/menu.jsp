	...
	<div class="container-fluid" >
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mb-2 mb-lg-0"> <!-- 마진엔드-오토 빼기 -->
				...
				<li class="nav-item" id ="uid" style="display:none;"><a class="nav-link active" aria-current="page" href="/pro/list" style="color: #2bd47b"></a></li><!-- users라고하면 원래 users에 있던거 (/) 가 실행된다. -->
